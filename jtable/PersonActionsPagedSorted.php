...
try
{
	...
	{
		//Get record count
		$result = mysql_query("SELECT COUNT(*) AS RecordCount FROM hegesztes_dat_nyelv;");
		$row = mysql_fetch_array($result);
		$recordCount = $row['RecordCount'];

		//Get records from database
		$result = mysql_query("SELECT * FROM hegesztes_dat_nyelv ORDER BY " . $_GET["jtSorting"] . " LIMIT " . $_GET["jtStartIndex"] . "," . $_GET["jtPageSize"] . ";");
