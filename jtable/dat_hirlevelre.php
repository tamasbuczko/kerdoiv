...
try
{
	...
	else if($_GET["action"] == "create")
	{
		...
		$result = mysql_query("INSERT INTO $data_table (email, status) VALUES ('" . $_POST["email"] . "', '" . $_POST["status"] . "');");
	...
	else if($_GET["action"] == "update")
	{
		...
		$result = mysql_query("UPDATE $data_table SET email = '" . $_POST["email"] . "', status = '" . $_POST["status"] . "' WHERE sorszam = '" . $_POST["sorszam"] . "';");
