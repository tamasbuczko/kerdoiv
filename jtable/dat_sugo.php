...
try
{
	...
	else if($_GET["action"] == "create")
	{
		...
		$result = mysql_query("INSERT INTO $data_table (hu, en, de, megjegyzes) VALUES ('" . $_POST["hu"] . "', '" . $_POST["en"] . "', '" . $_POST["de"] . "', '" . $_POST["megjegyzes"] . "');");
	...
	else if($_GET["action"] == "update")
	{
		...
		$result = mysql_query("UPDATE $data_table SET hu = '" . $_POST["hu"] . "', en = '" . $_POST["en"] . "', de = '" . $_POST["de"] . "', megjegyzes = '" . $_POST["megjegyzes"] . "' WHERE id = '" . $_POST["id"] . "';");
