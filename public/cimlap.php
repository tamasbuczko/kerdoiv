...
$result = mysql_query ("SELECT DISTINCT va.kerdoiv_sorszam, ki.cim_hu, ki.cim_de, ki.cim_en FROM valaszadasok AS va
...
while ($next_element = mysql_fetch_array($result)){
    $kitoltott_kerdoivek .= '<a href="?p=kerdoiv&amp;kerdoiv='.$next_element['cim_'.$_SESSION[lang]].'">'.$next_element['cim_'.$_SESSION[lang]].'</a>'."\n";
}
