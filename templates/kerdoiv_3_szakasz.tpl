...
{if $kerdoiv_obj->szemelyes_adat_tipusok['neme']}
				...
				<select name="neme" class="col-xs-10 col-sm-5 col-md-5 col-lg-5">
...
{if $kerdoiv_obj->szemelyes_adat_tipusok['kora']}
	...
	<select name="eletkora" class="col-xs-10 col-sm-5 col-md-5 col-lg-5">
		<option value="x">---</option>
...
{if $kerdoiv_obj->szemelyes_adat_tipusok['foglalkozas']}
	...
	<select name="foglalkozas" class="col-xs-10 col-sm-5 col-md-5 col-lg-5">
		<option value="x">---</option>
...
{if $kerdoiv_obj->szemelyes_adat_tipusok['orszag']}
	...
	<select name="lakhely" class="col-xs-10 col-sm-5 col-md-5 col-lg-5">
		<option value="x">---</option>
...
{if $kerdoiv_obj->szemelyes_adat_tipusok['csaladiallapot']}
	...
	<select name="csaladiallapot" class="col-xs-10 col-sm-5 col-md-5 col-lg-5">
		<option value="x">---</option>
...
{if $kerdoiv_obj->szemelyes_adat_tipusok['jovedelem']}
	...
	<select name="jovedelmek" class="col-xs-10 col-sm-5 col-md-5 col-lg-5">
		<option value="x">---</option>
...
{if $kerdoiv_obj->szemelyes_adat_tipusok['vegzettseg']}
	...
	<select name="vegzettseg" class="col-xs-10 col-sm-5 col-md-5 col-lg-5">
		<option value="x">---</option>
